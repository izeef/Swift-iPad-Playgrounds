...
public func assessmentPoint() -> AssessmentResults {
    ...
    var hints = [
        ...
        "One approach is to use a `for` loop that moves your character along the central path and checks for a gem or a closed switch. If your charaacter is on a closed switch, use a left turn; if your character is on a gem, use a right turn.",
