...
public func assessmentPoint() -> AssessmentResults {
    ...
    var success = "Great work! You're writing and using your own functions. That's a major part of what it means to be a coder. With a [function](glossary://function) you can group commands together and [call](glossary://call) the function once to run the whole set of commands. Using functions makes code much more readable and understandable at a glance. \n\n[**Next Page**](@next)"
    ...
    if checker.didUseForLoop || checker.didUseWhileLoop {
        ...
        success = "### Getting there! \nYou found a solution to the puzzle, but you didn't [define](glossary://define) your own function. You used \(checker.calledFunctions.count) commands, but you can solve the puzzle with fewer than 24. Try defining your own [function](glossary://function) using `func name() {}` and giving it a set of commands, then calling it to solve the puzzle. You won't need to use as many commands, and your code will be more readable."
