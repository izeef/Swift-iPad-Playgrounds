...
Now try making your `while` loops even smarter. To solve this puzzle, you’ll need a [`while` loop](glossary://while%20loop) to toggle open every switch along the three platforms. However, you can't use the condition `isOnClosedSwitch`, or the loop will stop running when you reach a portal or an open switch.
